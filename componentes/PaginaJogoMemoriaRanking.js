...
import { getRankingMemoria } from './firebaseConfig';

const PaginaJogoMemoriaRanking = () => {
        ...
        <ScrollView contentContainerStyle={estilos.scrollContainer}>
          {rankings.map((ranking, index) => (
            <View key={index} style={estilos.item}>
              ...
              <Text style={estilos.texto}>Movimentos: {ranking.moves}</Text>
            </View>
          ))}
        </ScrollView>
      </View>
...
export default PaginaJogoMemoriaRanking;
